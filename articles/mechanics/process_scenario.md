...
1. Сотрудник нажимает кнопку "Приостановить приём".
   1. Формируется запрос на бэкэнд на эндпоинт приостановки приёма ([POST /window_work](../endpoints/window.md)), в параметр Action записывается 0.
...
1. Сотрудник нажимает кнопку "Завершить работу с очередью".
   1. Формируется запрос на бэкэнд на эндпоинт приостановки приёма ([POST /window_work](../endpoints/window.md)), в параметр Action записывается 1.
